...
const PersonalPage = () => {
    ...
    useEffect(async () => {
        const getData = await Axios.post('http://amagpieinthesky/back/getName', {name: id})
    ...
    const handleShareBtn = async() => {
        const getData = await Axios.post('http://amagpieinthesky/back/changestatus', {name: id})
        console.log(getData.data)

        Axios.post('http://amagpieinthesky/back/generatedynamiclink', {name: id})
        .then((resp) => {
