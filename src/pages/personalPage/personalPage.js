...
const PersonalPage = () => {
    ...
    useEffect(async () => {
        const getData = await Axios.post('http://localhost:5000/admin/getName', {name: id})
    ...
    const handleShareBtn = async() => {
        const getData = await Axios.post('http://localhost:5000/admin/changestatus', {name: id})
        console.log(getData.data)

        Axios.post('http://localhost:5000/admin/generatedynamiclink', {name: id})
        .then((resp) => {
